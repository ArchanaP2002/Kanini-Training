...
namespace FitnessApi.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private readonly FitnessContext _context; //inherits from DbContext and represents the database context
        public TokenController(IConfiguration config, FitnessContext context)
        {
        ...
        {
            if (_userData != null && _userData.Email != null && _userData.Password != null) // it checks the userdata is not null 
            {
